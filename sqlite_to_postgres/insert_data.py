class InsertWorker:
    ...
    def insert_person(self, cursor, person_data: list) -> None:
    ...
    def insert_film_work(self, cursor, film_work_data: list) -> None:
        for item in film_work_data:
            cursor.execute("""
    ...
    def insert_genre(self, cursor, genre_data: list) -> None:
    ...
    def insert_genre_film_work_data(self, cursor,
                                    genre_film_work_data: list) -> None:
        for item in genre_film_work_data:
            cursor.execute("""
    ...
    def insert_person_film_work_data(self, cursor,
                                     person_film_work_data: list) -> None:
        for item in person_film_work_data:
            cursor.execute("""
